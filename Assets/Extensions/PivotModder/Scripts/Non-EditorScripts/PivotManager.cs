            ...
            if (recognizedTransform)
            {
                ...
                if (forObject)
                {
                    ...
                    if (selectedObjectMeshFilter)
                    {
                        ...
                        ModelImporter imp = ModelImporter.GetAtPath(path) as ModelImporter;
                        ...
                        if (AssetDatabase.Contains(selectedObjectMeshFilter.sharedMesh) && imp == null && !path.Substring(0, 7).Trim().ToLower().Equals("library"))
                        {
